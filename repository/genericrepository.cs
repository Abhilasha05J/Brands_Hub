...
namespace onlineshoppingstore.Repository
{
    public class GenericRepository<Tbl_Entity> : IRepository<Tbl_Entity> where Tbl_Entity : class
    {
        ...
        public IQueryable<Tbl_Entity> GetAllRecordsIQueryble()
        {
            return _dbSet;
        }
        ...
        public void InactiveAndDeletMarkByWhereClause(Expression<Func<Tbl_Entity, bool>> wherePredict, Action<Tbl_Entity> ForEachPredict)
        {
        ...
        public void view(Tbl_product tbl)
        {
